  ...
  const samples = [
    {
      ...
      location: 'Main Marine Gallery — Under the Sea',
      floor: 1,
      mapZone: 'marine_story',
      pinX: 62.0,
      pinY: 34.0,
    ...
    },
    {
      ...
      year: 'Permanent exhibit',
      location: 'Main Marine Gallery — River Basin',
      floor: 1,
      mapZone: 'marine_story',
      pinX: 42.0,
      pinY: 28.0,
    ...
    },
    {
      ...
      year: 'Permanent exhibit',
      location: 'Splash Zone (Live Touch Pool)',
      floor: 1,
      mapZone: 'splash_zone',
      pinX: 84.0,
      pinY: 52.0,
    ...
    },
    {
      ...
      year: 'Permanent exhibit',
      location: 'Office Extension — Heritage Gallery',
      floor: 1,
      mapZone: 'office_extension',
      pinX: 20.0,
      pinY: 76.0,
    ...
    },
    {
      ...
      year: 'Permanent exhibit',
      location: 'Office Extension — Marañon Memorial Gallery',
      floor: 1,
      mapZone: 'office_extension',
      pinX: 18.0,
      pinY: 66.0,
    ...
    },
    {
      ...
      year: 'Permanent exhibit',
      location: 'Second Floor — Toys Area',
      floor: 2,
      mapZone: 'second_floor_toys',
      pinX: 32.0,
      pinY: 48.0,
    ...
    },
    {
      ...
      origin: 'Marine Conservation Education Program',
      year: 'Permanent exhibit',
      location: 'Main Marine Gallery — Biodiversity Wall',
      floor: 1,
      mapZone: 'marine_story',
      pinX: 52.0,
      pinY: 22.0,
    ...
    },
    {
      ...
      year: 'Since 2019',
      location: 'Main Marine Gallery — Environmental Corner',
      floor: 1,
      mapZone: 'marine_story',
      pinX: 70.0,
      pinY: 24.0,
    ...
    },
    {
      ...
      year: 'Since 2019',
      location: 'Second Floor — Carnival Discovery Room',
      floor: 2,
      mapZone: 'second_floor_carnival',
      pinX: 62.0,
      pinY: 48.0,
    ...
    },
    {
      ...
      year: 'Since 2019',
      location: "Office Extension — Franco's Reading Corner",
      floor: 1,
      mapZone: 'office_extension',
      pinX: 20.0,
      pinY: 58.0,
    ...
    },
    {
      ...
      year: 'Permanent exhibit',
      location: 'Outdoor — Behind Main Building',
      floor: 1,
      mapZone: 'mangrove_walk',
      pinX: 50.0,
      pinY: 8.0,
